...
const StageContactInfo = ({ setAreRequiredFieldsFilled, setContactInfo, contactInfo }) => {
    ...
    <div>
      ...
      <form ref={formRef} className="text-start">
        <div className="mb-3">
          ...
          <input defaultValue={contactInfo.name} name="name" ref={nameInput} onChange={onChange} type="text" placeholder="Olga" className="form-control" id="name"
                 required={true}/>
        </div>

        <div className="mb-3">
          <label htmlFor="phone" className="form-label">Your phone <span style={{ color: 'red' }}>*</span></label>
          <input defaultValue={contactInfo.phone} name="phone" ref={phoneInput} onChange={onChange} type="tel" placeholder="+375 (33) 382-98-73"
        ...
        <div className="mb-3">
          ...
          <input defaultValue={contactInfo.email} name="email" ref={emailInput} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
